...
armors = [
    Armor('None', '', 0, 0),
    Armor('Leather Armor', 'Sturdy leather armor with metal pieces built in.', 5, 0, 'str', 3),
    Armor('Robe', 'A cloth robe covered over the user that provides little defense.', 1, 4)
]